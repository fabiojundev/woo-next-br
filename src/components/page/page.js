			...
			<Link href={`/pagina/${page?.slug}/`}>
				<a>
					<figure className="overflow-hidden mb-4">
						<Image { ...page?.featuredImage?.node } width="400" height="225" layout="fill" containerClassNames="w-96 sm:-w-600px md:w-400px h-56 sm:h-338px md:h-225px" title={page?.title ?? ''}/>
					</figure>
					<h2 
